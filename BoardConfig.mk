...
BOARD_KERNEL_CMDLINE := console=null androidboot.console=null androidboot.hardware=qcom user_debug=23 msm_rtb.filter=0x37 maxcpus=2 androidboot.selinux=permissive androidboot.bootdevice=msm_sdcc.1
